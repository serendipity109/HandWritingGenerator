...
wd = os.getcwd()
semantic_source = wd + '/utils/char_source/road_corpus.txt'
...
def generate_img(img, q=None):
    ...
    line = random.sample(char_list, 1)[0]
    if len(line) > 10:
    ...
    dst_img.save(images_dst_folder + "/302" + filename + '.jpg')
    text = u''.join(selected_char_list)
    line = "302" + filename + '.jpg ' + text
