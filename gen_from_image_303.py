...
wd = os.getcwd()
semantic_source = wd + '/utils/char_source/303.txt'
# semantic_source = wd + '/utils/char_source/area_corpus.txt'
# char_img_list_path = wd + '/utils/std_6964_image_list.json'
char_img_list_path = wd + '/utils/chnum.json'
# images_dst_folder = wd + '/temp_dst_folder'
images_dst_folder = '/home/sightour/Desktop/training_data/keras-chinese-ocr/train/images/tmpp'
tmp_text_path = wd + "/tmpp_text.txt"
...
def trim_img(src_img, word_size):
...
class HandWritingGenerator:
    ...
    def img_synthesis(self, filename):
        ...
        # cv2.imwrite(f'/home/sightour/Desktop/training_data/keras-chinese-ocr/train/images/tmpp/{filename}_1.jpg', synthesised_img)
...
def generate_img(img, q=None):
    ...
    for c in chars:
        ...
        while img_path is None:
            ...
            if c in num:
                ...
                dilated_img = dilate(src_img)
                trimmed_img = trim_img(dilated_img, word_size)
    ...
    # text_img.save(images_dst_folder + "/303" + filename + '_2.jpg')
    dst_img = ea.do_variation(text_img, filename)
    dst_img.save(images_dst_folder + "/303" + filename + '.jpg')
    text = u''.join(selected_char_list)
    line = "303" + filename + '.jpg ' + text
